...
const Testimonial = () => {
  ...
  return (
    <section id='testimonials' className='py-12 pb-16 md:py-14 md:pb-14 lg:py-28 lg:pb-28 bg-black overflow-hidden'>
                  ...
                  <div className='text-[15px] w-full h-full px-6'>
                    ...
                    <div className='py-8 w-[95%] mx-auto'>
                      <p className='text-center'>
                        ...
                        <span className='px-2 text-[14px] text-black'>{testimonial.comment}</span>
