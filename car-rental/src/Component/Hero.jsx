    ...
    <section id='home' className='w-full h-[100vh] lg:px-[30px] bg-orange-200 flex items-center justify-center'>
      <div className='w-full md:w-[50%] flex flex-col items-center md:items-start lg:block md:pl-16'>
        <motion.h3
          ...
          className='text-primaryColor text-3xl lg:text-5xl text-center md:text-left font-extrabold mb-11 md:mb-8 lg:mb-11'>Experience the Pinnacle of Elegance</motion.h3>
        <motion.p
          initial={{ translateX: -300, opacity: 0 }}
          animate={{ translateX: 0, opacity: 1 }}
          transition={{ duration: 1, delay: 0.4 }}
          className='text-[16px] text-center md:text-left text-black mb-11 md:mb-8 lg:mb-11 w-[80%]'
