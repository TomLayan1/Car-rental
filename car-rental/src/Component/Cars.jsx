...
const Cars = () => {
  ...
  return (
    <section id='vahicle-models' className='py-20'>
      ...
      <p className='text-[15px] text-center font-bold mb-20 md:w-[60%] mx-auto'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus quis tempus massa. Aenean erat nisl, gravida vel vestibulum cursus</p>
